 ...
 */
export function hotwireScreens({ url, component = HotwireScreen }: HotwireScreensOptions) {
  const routes = defaultVisitRoutes as Required<VisitRoutes>;
  return (
    <>
      <Stack.Screen name={routes.default} component={component} getId={webRouteId} initialParams={{ url }} options={{ title: '' }} />
